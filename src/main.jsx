...
import AddClient from './pages/admin/AddAgents.jsx';
...
const routes = [
  ...
  {
    path:"/admin/agents/",
    element: <IsAdminOrAgentRoute><AgentsList/></IsAdminOrAgentRoute>,
  },
  {
  ...
  {
    path:"/new-agent/",
    element: <IsAdminOrAgentRoute><AddClient/></IsAdminOrAgentRoute>,
  },
  {
