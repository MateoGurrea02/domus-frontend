  ...
  return (
    <>
      ...
      <div className="flex flex-col mb-10">
        <div className="flex flex-col ml-40 my-5">
        ...
        <div className="ml-40 my-5">
          <h2 className="text-amber-500 text-5xl font-bold">Disponible</h2>
          <h3 className="text-xl mt-10">Informacion</h3>
          <div className="flex mt-5">
            ...
            <p>6 personas<span className="mx-2">•</span>2 habitaciones<span className="mx-2">•</span>1 baño</p>
          </div>
          <div className="flex mt-5">
            <div className="mr-5">
